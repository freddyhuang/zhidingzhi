...
var Zepto = function() {
	...
	function $(t) {
		return Z(t) && !D(t) && Object.getPrototypeOf(t) == Object.prototype
	}
	...
	function X(n, i, r) {
		for(e in i) r && ($(i[e]) || M(i[e])) ? ($(i[e]) && !$(n[e]) && (n[e] = {}), M(i[e]) && !M(n[e]) && (n[e] = []), X(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e])
	}
	...
	return S.matches = function(t, e) {
		...
		var i, r = t.parentNode,
			o = !r;
		return o && (r = N).appendChild(t), i = ~S.qsa(r, e).indexOf(t), o && N.removeChild(t), i
	}, C = function(t) {
		...
		var a, u, f;
		return h.test(e) && (a = n(s.createElement(RegExp.$1))), a || (e.replace && (e = e.replace(p, "<$1></$2>")), i === t && (i = l.test(e) && RegExp.$1), i in x || (i = "*"), f = x[i], f.innerHTML = "" + e, a = n.each(o.call(f.childNodes), function() {
			f.removeChild(this)
		})), $(r) && (u = n(a), n.each(r, function(t, e) {
		...
		var n, i = "#" == e[0],
			...
			a = i || r ? e.slice(1) : e,
			s = E.test(a);
		return _(t) && s && i ? (n = t.getElementById(a)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : o.call(s && !i ? r ? t.getElementsByClassName(a) : t.getElementsByTagName(e) : t.querySelectorAll(e))
	}, n.contains = function(t, e) {
		return t !== e && t.contains(e)
	}, n.type = L, n.isFunction = A, n.isWindow = D, n.isArray = M, n.isPlainObject = $, n.isEmptyObject = function(t) {
		var e;
		for(e in t) return !1;
		return !0
		...
		ready: function(t) {
			return b.test(s.readyState) && s.body ? t(n) : s.addEventListener("DOMContentLoaded", function() {
				t(n)
			}, !1), this
		},
		get: function(e) {
		...
		not: function(e) {
			...
			if(A(e) && e.call !== t) this.each(function(t) {
				...
				var r = "string" == typeof e ? this.filter(e) : R(e) && A(e.item) ? o.call(e) : n(e);
		...
		siblings: function(t) {
			return V(this.map(function(t, e) {
				return a.call(I(e.parentNode), function(t) {
					return t !== e
				})
			}), t)
		},
		...
		attr: function(n, i) {
			...
			return "string" == typeof n && i === t ? 0 == this.length || 1 !== this[0].nodeType ? t : "value" == n && "INPUT" == this[0].nodeName ? this.val() : !(r = this[0].getAttribute(n)) && n in this[0] ? this[0][n] : r : this.each(function(t) {
				if(1 === this.nodeType)
					if(Z(n))
						for(e in n) B(this, e, n[e]);
					else B(this, n, Y(this, i, t, this.getAttribute(n)))
			})
		},
		...
		prop: function(e, n) {
			return e = O[e] || e, n === t ? this[0] && this[0][e] : this.each(function(t) {
			...
			if(arguments.length < 2) {
				...
				if(M(t)) {
					...
					return n.each(M(t) ? t : [t], function(t, e) {
						a[e] = r.style[C(e)] || o.getPropertyValue(e)
					}), a
				}
			}
			var s = "";
			if("string" == L(t)) i || 0 === i ? s = F(t) + ":" + U(t, i) : this.each(function() {
				this.style.removeProperty(F(t))
			});
			else
				for(e in t) t[e] || 0 === t[e] ? s += F(e) + ":" + U(e, t[e]) + ";" : this.each(function() {
		...
		removeClass: function(e) {
			return this.each(function(n) {
				return e === t ? J(this, "") : (i = J(this), Y(this, e, n, i).split(/\s+/g).forEach(function(t) {
					i = i.replace(q(t), " ")
				}), void J(this, i.trim()))
			})
		},
		...
		n.fn[e] = function(r) {
			var o, a = this[0];
			return r === t ? D(a) ? a["inner" + i] : _(a) ? a.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function(t) {
		...
		n.fn[t] = function() {
			...
			return r.length < 1 ? this : this.each(function(t, s) {
				o = i ? s : s.parentNode, s = 0 == e ? s.nextSibling : 1 == e ? s.firstChild : 2 == e ? s : null, r.forEach(function(t) {
					if(a) t = t.cloneNode(!0);
					else if(!o) return n(t).remove();
					G(o.insertBefore(t, s), function(t) {
	...
	}), S.Z.prototype = n.fn, S.uniq = P, S.deserializeValue = W, n.zepto = S, n
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	function(t) {
		...
		t.fn.delegate = function(t, e, n) {
			...
			return e && !o(e) ? (t.each(e, function(t, e) {
				h.on(t, a, s, e, f)
			}), h) : (o(a) || r(u) || u === !1 || (u = s, s = a, a = n), (r(s) || s === !1) && (u = s, s = n), u === !1 && (u = x), h.each(function(n, r) {
				f && (c = function(t) {
	...
	function(t) {
		...
		function E(e) {
			e.processData && e.data && "string" != t.type(e.data) && (e.data = t.param(e.data, e.traditional)), !e.data || e.type && "GET" != e.type.toUpperCase() || (e.url = b(e.url, e.data), e.data = void 0)
		}
		...
		function S(e, n, i, r) {
			...
			t.each(n, function(n, u) {
				o = t.type(u), r && (n = i ? r : r + "[" + (s || "object" == o || "array" == o ? n : "") + "]"), !r && a ? e.add(u.name, u.value) : "array" == o || !i && "object" == o ? S(e, u, i, n) : e.add(n, u)
			})
		}
		var i, r, e = 0,
			n = window.document,
		...
		t.active = 0, t.ajaxJSONP = function(i, r) {
			...
			p(n), n.crossDomain || (n.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(n.url) && RegExp.$2 != window.location.host), n.url || (n.url = window.location.toString()), E(n), n.cache === !1 && (n.url = b(n.url, "_=" + Date.now()));
			var a = n.dataType,
				s = /\?.+=\?/.test(n.url);
			if("jsonp" == a || s) return s || (n.url = b(n.url, n.jsonp ? n.jsonp + "=?" : n.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(n, o);
			var T, u = n.accepts[a],
				f = {},
				l = function(t, e) {
					f[t.toLowerCase()] = [t, e]
			...
			if(d.setRequestHeader = l, d.onreadystatechange = function() {
					if(4 == d.readyState) {
						d.onreadystatechange = w, clearTimeout(T);
						var e, i = !1;
						if(d.status >= 200 && d.status < 300 || 304 == d.status || 0 == d.status && "file:" == h) {
							a = a || x(n.mimeType || d.getResponseHeader("content-type")), e = d.responseText;
							try {
			...
			d.open(n.type, n.url, j, n.username, n.password);
			for(r in f) y.apply(d, f[r]);
			return n.timeout > 0 && (T = setTimeout(function() {
				d.onreadystatechange = w, d.abort(), v(null, "timeout", d, n, o)
	...
	function(t, e) {
		...
		t.each(a, function(t, r) {
			...
			var s, b, j, u = {},
				...
				C = !1;
			if(i === e && (i = t.fx.speeds._default / 1e3), a === e && (a = 0), t.fx.off && (i = 0), "string" == typeof n) u[m] = n, u[g] = i + "s", u[y] = a + "s", u[v] = r || "linear", S = t.fx.animationEnd;
			else {
				b = [];
				for(s in n) f.test(s) ? E += s + "(" + n[s] + ") " : (u[s] = n[s], b.push(x(s)));
				E && (u[c] = E, b.push(c)), i > 0 && "object" == typeof n && (u[l] = b.join(", "), u[h] = i + "s", u[d] = a + "s", u[p] = r || "linear")
			}
			return j = function(e) {
				...
				C = !0, t(this).css(w), o && o.call(this)
